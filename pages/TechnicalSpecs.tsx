                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse">
                            ...
                            <tbody className="divide-y divide-white/5">
                                {loading ? (
                                    <tr>
                                        <td colSpan={5} className="p-8 text-center text-gray-500 animate-pulse text-xs font-bold uppercase tracking-widest">Cargando datos...</td>
                                    </tr>
                                ) : specs.length === 0 ? (
                                    <tr>
                                        <td colSpan={5} className="p-8 text-center text-gray-500 text-xs font-bold uppercase tracking-widest">No hay datos registrados aún.</td>
                                    </tr>
                                ) : (
                                    specs.map((spec) => (
