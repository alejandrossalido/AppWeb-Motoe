...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { id: 'lab', label: 'Laboratorio IA', icon: 'science', path: '/lab', roles: ['owner', 'coordinator', 'team_lead', 'member', 'partner'] },
    { id: 'calendar', label: 'Calendario', icon: 'calendar_month', path: '/calendario', roles: ['owner', 'coordinator', 'team_lead', 'member', 'partner'] },
    { id: 'team', label: 'Gestión Equipo', icon: 'groups', path: '/equipo', roles: ['owner', 'coordinator', 'team_lead'] },
    ...
    <aside className="w-16 lg:w-64 flex-shrink-0 flex flex-col bg-[#0f0f0f] border-r border-white/5 z-50">
      ...
      <div className="p-2 lg:p-4 border-t border-white/5 space-y-2">
        <Link to="/configuracion" className="flex items-center gap-3 rounded-xl bg-white/5 p-2 cursor-pointer hover:bg-white/10 transition-colors">
          <img className="h-8 w-8 lg:h-9 lg:w-9 rounded-full border border-primary/30 shrink-0 object-cover" src={currentUser.avatar} alt="P" />
